...
function setup() {
	...
	*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'translation-slug' ),
		)
	);
	...
	*/
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'themeprefix_custom_background_args',
			array(
...
function widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'translation-slug' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'translation-slug' ),
...
function enqueue_assets() {
	...
	wp_style_add_data( 'parcel-style', 'rtl', 'replace' );
